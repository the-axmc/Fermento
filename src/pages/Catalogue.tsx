...
const Catalogue: React.FC = () => {
  ...
  const transformP1toP2 = async (p1: FermentationProduct) => {
    ...
    try {
      ...
      alert("🎉 Fermentation completed: P1 burned (if supported) and P2 minted.");
    } catch (err: unknown) {
      // eslint-disable-next-line no-console
      console.error(err);
    ...
    <Layout.Content>
      <Layout.Inset>
        ...
        <p style={{ color: "#6b7280" }}>
          ...
          complete fermentation → burn P1 (if supported) and mint P2.
        </p>
              ...
              <Card>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  <div style={{ color: "#6b7280", fontSize: 12 }}>
                    {p.type} • token #{p.tokenId} • started {p.startDate}
                  </div>
                </div>
